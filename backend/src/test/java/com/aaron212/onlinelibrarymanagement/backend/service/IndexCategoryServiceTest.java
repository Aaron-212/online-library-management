...
class IndexCategoryServiceTest {
    ...
    void testAddCategoryWithHierarchy_ExistingCategory() {
        ...
        when(indexCategoryRepository.findByIndexCode(eq(categoryCode)))
        ...
        when(indexCategoryRepository.save(any(IndexCategory.class))).thenAnswer(invocation -> invocation.getArgument(0));
    ...
    void testAddCategoryWithHierarchy_NullInput() {
        ...
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> indexCategoryService.addCategoryWithHierarchy(null)
        );
    ...
    void testAddCategoryWithHierarchy_EmptyInput() {
        ...
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> indexCategoryService.addCategoryWithHierarchy("")
        );
